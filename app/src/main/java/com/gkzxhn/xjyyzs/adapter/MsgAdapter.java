...
//        holder.tv_msg_title.setText();
    ...
    class MsgViewHolder extends RecyclerView.ViewHolder{
        ...
        @BindView(R.id.tv_msg_title) TextView tv_msg_title;
        @BindView(R.id.tv_msg_receive_time) TextView tv_msg_receive_time;
        @BindView(R.id.tv_msg_content) TextView tv_msg_content;
